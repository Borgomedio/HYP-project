    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for(var i=0;i<categoria.length;i++){
                ...
                ell+= "<div class='col-md-12 col-sx-11' id='info'><h3>Description</h3><p>"+categoria[i].B+"</p></div><div class='col-md-4 portfolio-item' ><a href=''><img class='img-responsive' src='"+categoria[i].C+"' alt=''></a><h5><a href='#'></a></h5><p class='prezzo'></p><a href='#' class='btn btn-primary' role='button'>View More</a></div><div class='col-md-4 portfolio-item' ><a href=''><img class='img-responsive' src='"+categoria[i].D+"' alt=''></a><h5><a href='#'></a></h5><p class='prezzo'></p><a href='#' class='btn btn-primary' role='button'>View More</a></div><div class='col-md-4 portfolio-item' ><a href=''><img class='img-responsive' src='"+categoria[i].E+"' alt=''></a><h5><a href='#'></a></h5><p class='prezzo'></p><a href='#' class='btn btn-primary' role='button'>View More</a></div>";
