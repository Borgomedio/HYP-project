...
function SLgenerica(nome){
    ...
    el2+="<a href='/pages/smart-faq.html' id='link2' type='button' class='btn btn-primary '><span class='glyphicon  glyphicon-question-sign' aria-hidden='true'></span>Go to FAQ</a></div>";
    }
                        
    if(nome=="TIMhome"){                    
   el3+="</div><!--chiuso row--><div class='row'>   <div class='col-md-12 col-sx-11 dev-rel'><h4>Related Devices</h4><div id='blocco-img' ><a href='/pages/device.php?nome=Galaxy Gear S&tipo=TV-SmartLiving'><img class='img-responsive' src='http://hypproject.altervista.org/immagini/Devices/Galaxy_Gear_S.jpg'></a><a href='/pages/device.php?nome=Repeater Wi-Fi ZyXEL AC750&tipo=Modem-Networking'><img class=' img-responsive' src='http://hypproject.altervista.org/immagini/Modem%20e%20networking/blocchetto-repeater-zyxel-ac750.png'></a></div></div></div></div><!--chiuso container-->";             
    }
            }}
