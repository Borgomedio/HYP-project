...
<div class="container">
    <div class="row">
            <div class="col-md-4 portfolio-item">
                <a href="#">
                    <img class="img-responsive" src="<?php echo $cicle['immagine']?>" alt="">
                </a>
                <h3>
                    <a href="#"><?php  echo $cicle['nome'];?> </a>
                </h3>
                <p><?php echo $cicle['descrizione']  ?></p>
            </div>
...
?>
      ...
      <!-- Codice PHP per connessione con DB -->
      ...
      <!-- FINE Codice PHP per connessione con DB -->
