...
<!--Fine passaggio parametro a funzione in JavaScript-->         
    ...
    <!--Inizio pulsanti Categorie-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sx-11 box">
                    <h3>Description</h3>
...
 
                    ...
                    The offer will be activated within a maximum of 48 hours of request. The validity of the offer is confirmed automatically every 30 days.</p>
                </div>
